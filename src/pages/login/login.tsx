import {ButtonsContainer, CheckBoxContainer, EmailInput, 
        GoogleLogo, InvalidEmailMessage, InvalidPasswordMessage,
        LoginButton, LoginContainer, MainContainer, MessageContainer, 
        PasswordInput, SignUp, SubTitle, Title }from "./login-styles";
  ...
  return (
    <MainContainer>
      <LoginContainer>
        ...
        <SubTitle>Continuar com YouTube</SubTitle>
        <EmailInput 
          type='email' 
          value={email} 
        ...
        <CheckBoxContainer>
          ...
          <label htmlFor="show-password">Exibir senha</label>
        </CheckBoxContainer>
        <ButtonsContainer>
